...
import java.util.*;
public class ComputerPlayerArrPrune // **** use your first name
{
    ...
    private char              startingPlayer = Tournament.getStartingPlayer(); // symbol of starting player
    private char[][]		  cells;
//	private char[][][][][][]  moves = {{{{}, {}, {}}, {{}, {
//		{{' ', ' ', ' '}, {' ', ' ', ' '}, {' ', ' ', ' '}}, }, {}}, {{}, {}, {}}}, {{{}, {}, {}}, {{}, {}, {}}, {{}, {}, {
//			{{' ', ' ', ' '}, {' ', 'O', ' '}, {' ', ' ', ' '}}, }}}, {{{}, {}, {}}, {{}, {}, {}}, {{}, {
...
//			{{'O', 'X', 'O'}, {'X', 'O', ' '}, {'X', 'O', 'X'}}, }}, {{}, {}, {}}}};
    ...
    public ComputerPlayerArrPrune(char symbol) // **** use your first name
    {
	mySymbol = symbol;
	oppSymbol = (mySymbol=='X') ? 'O' : 'X';
	if (mySymbol=='O') moves = movesO;
    }
	...
	for (int b=0; b<3; b++) for (int c=0; c<3; c++) for (char[][] arr: moves[turn][b][c]) {
		if (Arrays.deepEquals(arr, cells)) {
			return new int[] {b, c};
		}
	}	
